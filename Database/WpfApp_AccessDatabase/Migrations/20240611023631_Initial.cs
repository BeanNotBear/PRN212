    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Categori__19093A2BE787BEAD", x => x.CategoryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6EDF0A23507", x => x.ProductID);
                    table.ForeignKey(
                        name: "FK__Products__Catego__5CD6CB2B",
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Categori__8517B2E0E2F1679B",
                table: "Categories",
                column: "CategoryName",
                unique: true,
